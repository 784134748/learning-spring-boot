...
CREATE TABLE `sys_acl_module` (
  `id` bigint(11) NOT NULL AUTO_INCREMENT COMMENT '权限模块id',
  `name` varchar(20) NOT NULL DEFAULT '' COMMENT '权限模块名称',
  `parent_id` bigint(11) NOT NULL DEFAULT '0' COMMENT '上级权限模块id',
...
CREATE TABLE `sys_dept` (
  ...
  `parent_id` bigint(11) NOT NULL DEFAULT '0' COMMENT '上级部门id',
...
CREATE TABLE `sys_log` (
  ...
  `target_id` bigint(11) NOT NULL COMMENT '基于type后指定的对象id，比如用户、权限、角色等表的主键',
...
CREATE TABLE `sys_role_acl` (
  ...
  `acl_id` bigint(11) NOT NULL COMMENT '权限id',
  `operator` varchar(20) NOT NULL DEFAULT '' COMMENT '操作者',
  `operate_time` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '最后一次更新的时间',
...
CREATE TABLE `sys_user` (
  ...
  `dept_id` bigint(11) NOT NULL DEFAULT '0' COMMENT '用户所在部门的id',
